...
function PricingCard({
  ...
  return (
    <div className="group">
      <div className="w-full md:w-[40rem] xl:w-[370px] h-[380px] bg-white group-hover:bg-primary drop-shadow-sm group-hover:text-white shadow-sm rounded-[20px] text-center p-7 flex flex-col space-y-3 items-start justify-center">
