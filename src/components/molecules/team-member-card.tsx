...
function TeamMember({ name, image, role }: TeamMemberProps) {
  return (
    <div className="w-full md:w-[213px] xl:w-[370px] md:min-h-[345px] xl:min-h-[380px] bg-white group-hover:bg-primary drop-shadow-sm group-hover:text-white shadow-sm rounded-[20px] text-center flex flex-col space-y-3 items-start justify-center">
