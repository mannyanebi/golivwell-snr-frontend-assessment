...
function FeatureCard({
  ...
  return (
    <div className="w-full xl:w-[370px] h-[380px] bg-white shadow-sm rounded-[20px] text-center py-6 px-4 md:p-7 flex flex-col space-y-7 items-center justify-center">
      <div
